<template>
  <div id="app">
      ...
      <div class="sidebar-wrapper">
        <div class="columns">
          <div class="column logo-area">
            <q-icon :name="outlinedAccountCircle" />
            <h1>ADMIN Area</h1>
          </div>
        </div>
    ...
    <!-- main-panel -->
    <div class="main-panel hero is-fullheight">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="credits ml-auto">
            <span class="copyright"> Admin </span>
          </div>
        </div>
      </div>
    </footer>
...
<script setup>
import useMaterial from 'src/use/useMaterialFonsts';
const { outlinedAccountCircle, outlinedHome, outlinedLogout } = useMaterial();
...
const logout = () => {
  // LOGOUT CUSTOMER
  storeCustomerLogin.logout().then((res) => {
...
.sidebar[data-active-color='info']
  .nav
  li.active
  > a[data-toggle='collapse']
  ~ div
...
.off-canvas-sidebar[data-active-color='info']
  .nav
  li.active
  > a[data-toggle='collapse'],
.off-canvas-sidebar[data-active-color='info']
...
.sidebar[data-active-color='success']
  .nav
  li.active
  > a[data-toggle='collapse'],
.sidebar[data-active-color='success']
...
.off-canvas-sidebar[data-active-color='success']
  .nav
  li.active
  > a[data-toggle='collapse'],
.off-canvas-sidebar[data-active-color='success']
...
.sidebar[data-active-color='warning']
  .nav
  li.active
  > a[data-toggle='collapse'],
.sidebar[data-active-color='warning']
...
.off-canvas-sidebar[data-active-color='warning']
  .nav
  li.active
  > a[data-toggle='collapse'],
.off-canvas-sidebar[data-active-color='warning']
...
.sidebar[data-active-color='danger']
  .nav
  li.active
  > a[data-toggle='collapse']
  i,
...
.off-canvas-sidebar[data-active-color='danger']
  .nav
  li.active
  > a[data-toggle='collapse'],
.off-canvas-sidebar[data-active-color='danger']
